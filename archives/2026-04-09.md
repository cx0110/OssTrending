...
| 7 | [OpenBMB/VoxCPM](https://github.com/OpenBMB/VoxCPM) | 🔥 6947 | VoxCPM: Tokenizer-Free TTS for Context-Aware Speech Generation and True-to-Life Voice Cloning |
| 8 | [NVIDIA/personaplex](https://github.com/NVIDIA/personaplex) | 🔥 8345 | PersonaPlex code. |
| 9 | [atilaahmettaner/tradingview-mcp](https://github.com/atilaahmettaner/tradingview-mcp) | 🔥 1270 |  Advanced TradingView MCP Server for AI-powered market analysis. Real-time crypto & stock screening, technical indicators, Bollinger Band intellige... |
| 10 | [HKUDS/CLI-Anything](https://github.com/HKUDS/CLI-Anything) | 🔥 29408 | "CLI-Anything: Making ALL Software Agent-Native" -- CLI-Hub: https://clianything.cc/ |

## 🐹 Go (24h)

| 排名 | 项目 | Stars | 简介 (AI/Raw) |
| :--- | :--- | :--- | :--- |
| 1 | [router-for-me/CLIProxyAPI](https://github.com/router-for-me/CLIProxyAPI) | 🔥 24153 | 🤖 [Legacy] 该项目提供一个兼容OpenAI等模型的API服务，允许用户免费使用高级语言模型。 |
| 2 | [nextlevelbuilder/goclaw](https://github.com/nextlevelbuilder/goclaw) | 🔥 2274 | 🤖 [qwen/qwen3-32b] <think>
...
| 4 | [Wei-Shaw/sub2api](https://github.com/Wei-Shaw/sub2api) | 🔥 11027 | 🤖 [Legacy] Sub2API-CRS2 是一站式开源中转服务，统一接入多个 AI 订阅服务。 |
| 5 | [maaslalani/sheets](https://github.com/maaslalani/sheets) | 🔥 1628 | 🤖 [Legacy] 终端基于的电子表格工具。 |
| 6 | [sipeed/picoclaw](https://github.com/sipeed/picoclaw) | 🔥 27870 | Tiny, Fast, and Deployable anywhere — automate the mundane, unleash your creativity |
| 7 | [xoai/sage-wiki](https://github.com/xoai/sage-wiki) | 🔥 264 | An LLM-compiled personal knowledge base.  Drop in your papers, articles, and notes. sage-wiki compiles them into a structured, interlinked wiki — w... |
| 8 | [chenhg5/cc-connect](https://github.com/chenhg5/cc-connect) | 🔥 4597 | Bridge local AI coding agents (Claude Code, Cursor, Gemini CLI, Codex) to messaging platforms (Feishu/Lark, DingTalk, Slack, Telegram, Discord, LIN... |
| 9 | [gastownhall/gastown](https://github.com/gastownhall/gastown) | 🔥 13710 | Gas Town - multi-agent workspace manager |
| 10 | [NoFxAiOS/nofx](https://github.com/NoFxAiOS/nofx) | 🔥 11859 | Your personal AI trading assistant. Any market. Any model. Pay with USDC, not API keys. |
