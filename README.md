...
| 8 | [ArcReel/ArcReel](https://github.com/ArcReel/ArcReel) | 🔥 1394 | AI Agent 驱动的开源视频生成工作台 — 小说→角色/场景/道具设计→剧本→分镜图→视频，跨镜头角色与场景一致 \| Open-source AI video workspace powered by AI Agents, Nano Banana 2 & Veo 3.1 / Grok /... |
| 9 | [therealXiaomanChu/ex-skill](https://github.com/therealXiaomanChu/ex-skill) | 🔥 3400 | 把前任蒸馏成 AI Skill，用ta的方式跟你说话。Inspired by colleague-skill（同事skill）.  |
...
| 排名 | 项目 | Stars | 简介 (AI/Raw) |
| :--- | :--- | :--- | :--- |
| 1 | [router-for-me/CLIProxyAPI](https://github.com/router-for-me/CLIProxyAPI) | 🔥 23915 | 🤖 [Unknown] 该项目提供一个兼容OpenAI等模型的API服务，允许用户免费使用高级语言模型。 |
...
| 4 | [Wei-Shaw/sub2api](https://github.com/Wei-Shaw/sub2api) | 🔥 10843 | 🤖 [Unknown] Sub2API-CRS2 是一站式开源中转服务，统一接入多个 AI 订阅服务。 |
| 5 | [maaslalani/sheets](https://github.com/maaslalani/sheets) | 🔥 1579 | 🤖 [Unknown] 终端基于的电子表格工具。 |
| 6 | [sipeed/picoclaw](https://github.com/sipeed/picoclaw) | 🔥 27815 | Tiny, Fast, and Deployable anywhere — automate the mundane, unleash your creativity |
...
| 10 | [NoFxAiOS/nofx](https://github.com/NoFxAiOS/nofx) | 🔥 11836 | Your personal AI trading assistant. Any market. Any model. Pay with USDC, not API keys. |
